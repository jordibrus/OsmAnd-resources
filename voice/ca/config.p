...
% LEFT/RIGHT
string('prepare.ogg', "prepara't per").
string('after.ogg', 'després de ').

string('left.ogg', "gira a l'esquerra").
string('left_sh.ogg', "gira fort a l'esquerra").
string('left_sl.ogg', "gira lleument a l'esquerra").
string('right.ogg', 'gira a la dreta').
string('right_sh.ogg', 'gira fort a la dreta').
string('right_sl.ogg', 'gira lleument a la dreta').
